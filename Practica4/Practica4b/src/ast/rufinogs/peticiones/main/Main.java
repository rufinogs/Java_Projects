...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		Profesor profesor1 = new Profesor(1, "Manuel", "Marchena Gómez", 206, "Redes de Ordenador");
		Profesor profesor2 = new Profesor(2, "Cristian", "Jara Corros", 203, "Ampliación de Redes");
		Profesor profesor3 = new Profesor(3, "Pepe", "Jimenez Sanchez", 207, "Servicos Operativos");
		Profesor profesor4 = new Profesor(3, "Julia", "Matinez Garcia", 223, "Calculo");

		// Añadimos los profesores al array de profesores
		listprof.add(profesor1);
		listprof.add(profesor2);
		listprof.add(profesor3);
		listprof.add(profesor4);
